...
#if defined ( mem32 )
{
    ...
    // Body of the cycle
    {
        ...
        for ( i = 0; i <= n2-8; i += 8 ) {
            ...
            r00 = _mm256_loadu_pd( pr4 + 0 );
            r01 = _mm256_loadu_pd( pr4 + 4 );
            
            _mm256_storeu_pd( pc2 + 0, r00 );
            _mm256_storeu_pd( pc2 + 4, r01 );
    ...
    if ( i <= n2-2 ) {
        ...
        for ( ; i <= n2-2; i += 2 ) {
            ...
            _mm_storeu_pd( pc2, _mm_loadu_pd( pr4 ) );
...
#else
{
    ...
    // Body of the cycle
    {
        ...
        for ( i = 0; i <= n2-16; i += 16 ) {
            ...
            r00 = _mm512_loadu_pd( pr4 + 0 );
            r01 = _mm512_loadu_pd( pr4 + 8 );
            
            _mm512_storeu_pd( pc2 + 0, r00 );
            _mm512_storeu_pd( pc2 + 8, r01 );
            
            r02 = _mm512_loadu_pd( pr1 + 0 );
            r03 = _mm512_loadu_pd( pr1 + 8 );
            
            r02 = _mm512_mul_pd( rfac1, r02 );
            r03 = _mm512_mul_pd( rfac1, r03 );
            
            r00 = _mm512_loadu_pd( pr3 + 0 );
            r01 = _mm512_loadu_pd( pr3 + 8 );
            ...
            _mm512_storeu_pd( pc1 + 0, r00 );
            _mm512_storeu_pd( pc1 + 8, r01 );
