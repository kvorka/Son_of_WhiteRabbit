    ...
    do i3 = 1, l/5
      do i2 = 1, m
        do i1 = 1, 4
          !$omp simd
          do i0 = 1, ndbl
            x0im = x(i0,i1,i2,1,i3,1)
            x0re = x(i0,i1,i2,1,i3,4)
            x2im = x(i0,i1,i2,2,i3,1)
            x2re = x(i0,i1,i2,2,i3,4)
            
            x1re = x0im + x0re
            x4re = x0im - x0re
            
            x0im = x(i0,i1,i2,1,i3,2)
            ...
            x(i0,i1,i2,1,i3,0) = x0re + x4re
            x(i0,i1,i2,2,i3,0) = x0im + x4im
            ...
            x(i0,i1,i2,1,i3,1) = x0re
            x(i0,i1,i2,2,i3,1) = x0im
          end do
        end do
      end do
    end do
